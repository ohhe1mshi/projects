...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <form class="main-header__search" method="get" action="search.php" autocomplete="off">
            <input type="search" name="search" value="<?=htmlspecialchars(getGetVal("search"))?>" <?= $_SESSION['userId']?> placeholder="Поиск лота">
            <input class="main-header__search-btn" type="submit" name="find" value="Найти">
            <input type="hidden" name="page" value="1">
        </form>
        <a class="main-header__add-lot button <?php if(!isset($_SESSION['username'])): ?> visually-hidden <?php endif;?>" href="add.php">Добавить лот</a>
       ...
       <?php if(!empty($_SESSION['username'])): ?>
            <div class="user-menu__logged">
                ...
                <a class="user-menu__logout" href="exit.php">Выход</a>
            </div>
        <?php else: ?>
...
<main class="<?php if($title === 'Главная'): ?> container <?php endif;?>" >
    <?php if($title !== 'Главная') print($categoriesContent ?? '');?>
...
<footer class="main-footer">
    ...
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button <?php if(!isset($_SESSION['username'])): ?> visually-hidden <?php endif;?>" href="add.php">Добавить лот</a>
